...
" Original Author: Jacob Niehus  <https://github.com/wilywampa>
...
let g:pymode_syntax_print_as_function = get(g:, 'pymode_syntax_print_as_function', 1)
let g:pymode_syntax_highlight_equal_operator = get(g:, 'pymode_syntax_highlight_equal_operator', 1)
let g:pymode_syntax_highlight_stars_operator = get(g:, 'pymode_syntax_highlight_stars_operator', 1)
let g:pymode_syntax_highlight_self = get(g:, 'pymode_syntax_highlight_self', 1)
let g:pymode_syntax_indent_errors = get(g:, 'pymode_syntax_indent_errors', 1)
let g:pymode_syntax_space_errors = get(g:, 'pymode_syntax_space_errors', 1)
let g:pymode_syntax_string_formatting = get(g:, 'pymode_syntax_string_formatting', 1)
let g:pymode_syntax_string_format = get(g:, 'pymode_syntax_string_format', 1)
let g:pymode_syntax_string_templates = get(g:, 'pymode_syntax_string_templates', 1)
let g:pymode_syntax_doctests = get(g:, 'pymode_syntax_doctests', 1)
let g:pymode_syntax_docstrings = get(g:, 'pymode_syntax_docstrings', 1)
let g:pymode_syntax_builtin_objs = get(g:, 'pymode_syntax_builtin_objs', 1)
let g:pymode_syntax_builtin_types = get(g:, 'pymode_syntax_builtin_types', 1)
let g:pymode_syntax_builtin_funcs = get(g:, 'pymode_syntax_builtin_funcs', 1)
let g:pymode_syntax_highlight_exceptions = get(g:, 'pymode_syntax_highlight_exceptions', 1)

let g:pymode_syntax_slow_sync = get(g:, 'pymode_syntax_slow_sync', 0)
...
" ============
    ...
    syn keyword pythonStatement cdef cpdef ctypedef cppclass

    syn keyword pythonStatement def nextgroup=pythonFunction skipwhite
    syn match pythonFunction "\%(\%(def\s\|cppclass\s\|ctypedef\s\|cpdef\s\|cdef\s\|@\)\s*\)\@<=\h\%(\w\|\.\)*" contained nextgroup=pythonVars
    ...
    syn keyword pythonInclude       import from cimport
...
" ============
    ...
    if g:pymode_syntax_builtin_types
        ...
        syn keyword pythonBuiltinType void bint int short double float unsigned operator
        syn keyword pythonBuiltinType struct union enum
    endif
